...
-- ----------------------------
-- Table structure for drawing_image_labels
-- ----------------------------
DROP TABLE IF EXISTS `drawing_image_labels`;
CREATE TABLE `drawing_image_labels`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `image_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '关联图片ID',
  `label_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标签名称',
  `confidence` float NOT NULL COMMENT '置信度（0-1）',
  `label_source` enum('manual','auto_llm','auto_cnn','hybrid') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标签来源',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '图片标签' ROW_FORMAT = DYNAMIC;
