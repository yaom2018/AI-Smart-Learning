...
class InitializeData:
    ...
    async def generate_drawing_resource_images(self):
        """
        生成常见问题详情数据
        """
        await self.__generate_data("drawing_resource_images", help_models.VadminIssue)
    ...
    async def run(self, env: Environment = Environment.pro):
        ...
        await self.generate_drawing_resource_images()
