...
from apps.vadmin.intelligentInput.views import app as vadmin_intelligent_input
...
urlpatterns = [
    ...
    {"ApiRouter": vadmin_intelligent_input, "prefix": "/vadmin/IntelligentInput", "tags": ["AI智慧学"]},
]
